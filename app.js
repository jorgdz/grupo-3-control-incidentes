...
var incidentesAtendidos = require('./routes/incidentes-atendidos')
var incidentesPorMes = require('./routes/incidentes-por-meses')
...
app.use('/incidentes-atendidos', incidentesAtendidos)
app.use('/incidentes-por-meses', incidentesPorMes)
